...
from HTTP_Connectors import HTTP_Server
...
class TransectLine(HTTP_Server):
    ...
    def run(self):
        ...
        if not self.connecting:
            ...
            self.recv()
            print("recv_bytes", self.recv_bytes)
            print("connecting", self.connecting)
            print("connected", self.connected)
            if self.recv_bytes.decode() == "activate":
